...
function Button({ children, disabled, to, type }) {
  ...
  const styles = {
    ...
    secondary:
      "inline-block text-sm border-2 px-4 py-2.5 md:px-6 md:py-3.5 hover:text-stone-800 border-stone-300 rounded-full bg-transparent font-semibold uppercase tracking-wide text-stone-400 transition-colors duration-300 hover:bg-stone-300 focus:outline-none focus:text-stone-800 focus:ring focus:ring-stone-200 focus:ring-offset-2 disabled:cursor-not-allowed",
  };
